...
\begin{table}[H]
    ...
    \rowcolor{blue!5}
        ...
        \hline
        {{mass0}} & {{material0}} & {{wire_diameter0}} & {{mean_diameter0}} & {{free_length0}} & {{max_force_length0}} & {{spring_constant0}} & {{static_safety_coefficient0}} & {{fatigue_safety_coefficient0}} & {{obstacles_deflection0}} & {{effective_num_turns0}} & \href{{{url0}}}{{{code0}}} \\
        {{mass1}} & {{material1}} & {{wire_diameter1}} & {{mean_diameter1}} & {{free_length1}} & {{max_force_length1}} & {{spring_constant1}} & {{static_safety_coefficient1}} & {{fatigue_safety_coefficient1}} & {{obstacles_deflection1}} & {{effective_num_turns1}} & \href{{{url1}}}{{{code1}}} \\
        {{mass2}} & {{material2}} & {{wire_diameter2}} & {{mean_diameter2}} & {{free_length2}} & {{max_force_length2}} & {{spring_constant2}} & {{static_safety_coefficient2}} & {{fatigue_safety_coefficient2}} & {{obstacles_deflection2}} & {{effective_num_turns2}} & \href{{{url2}}}{{{code2}}} \\
        {{mass3}} & {{material3}} & {{wire_diameter3}} & {{mean_diameter3}} & {{free_length3}} & {{max_force_length3}} & {{spring_constant3}} & {{static_safety_coefficient3}} & {{fatigue_safety_coefficient3}} & {{obstacles_deflection3}} & {{effective_num_turns3}} & \href{{{url3}}}{{{code3}}} \\
        {{mass4}} & {{material4}} & {{wire_diameter4}} & {{mean_diameter4}} & {{free_length4}} & {{max_force_length4}} & {{spring_constant4}} & {{static_safety_coefficient4}} & {{fatigue_safety_coefficient4}} & {{obstacles_deflection4}} & {{effective_num_turns4}} & \href{{{url4}}}{{{code4}}} \\
        {{mass5}} & {{material5}} & {{wire_diameter5}} & {{mean_diameter5}} & {{free_length5}} & {{max_force_length5}} & {{spring_constant5}} & {{static_safety_coefficient5}} & {{fatigue_safety_coefficient5}} & {{obstacles_deflection5}} & {{effective_num_turns5}} & \href{{{url5}}}{{{code5}}} \\
        {{mass6}} & {{material6}} & {{wire_diameter6}} & {{mean_diameter6}} & {{free_length6}} & {{max_force_length6}} & {{spring_constant6}} & {{static_safety_coefficient6}} & {{fatigue_safety_coefficient6}} & {{obstacles_deflection6}} & {{effective_num_turns6}} & \href{{{url6}}}{{{code6}}} \\
        {{mass7}} & {{material7}} & {{wire_diameter7}} & {{mean_diameter7}} & {{free_length7}} & {{max_force_length7}} & {{spring_constant7}} & {{static_safety_coefficient7}} & {{fatigue_safety_coefficient7}} & {{obstacles_deflection7}} & {{effective_num_turns7}} & \href{{{url7}}}{{{code7}}} \\
        {{mass8}} & {{material8}} & {{wire_diameter8}} & {{mean_diameter8}} & {{free_length8}} & {{max_force_length8}} & {{spring_constant8}} & {{static_safety_coefficient8}} & {{fatigue_safety_coefficient8}} & {{obstacles_deflection8}} & {{effective_num_turns8}} & \href{{{url8}}}{{{code8}}} \\
        {{mass9}} & {{material9}} & {{wire_diameter9}} & {{mean_diameter9}} & {{free_length9}} & {{max_force_length9}} & {{spring_constant9}} & {{static_safety_coefficient9}} & {{fatigue_safety_coefficient9}} & {{obstacles_deflection9}} & {{effective_num_turns9}} & \href{{{url9}}}{{{code9}}} \\
        \hline
    \end{tabular}
    }
...
\begin{table}[H]
    ...
    \rowcolor{blue!5}
        ...
        \hline
        {{material0}} & {{Rm0}} & {{Reh0}} & {{G0}} & {{b_D0}} & {{delta_tau_00}} & {{b_tau0}} \\
        {{material1}} & {{Rm1}} & {{Reh1}} & {{G1}} & {{b_D1}} & {{delta_tau_01}} & {{b_tau1}} \\
        {{material2}} & {{Rm2}} & {{Reh2}} & {{G2}} & {{b_D2}} & {{delta_tau_02}} & {{b_tau2}} \\
        {{material3}} & {{Rm3}} & {{Reh3}} & {{G3}} & {{b_D3}} & {{delta_tau_03}} & {{b_tau3}} \\
        \hline
    \end{tabular}}
...
where:
\begin{itemize}
    \item \( k_\text{dist} = {{kdist}}\) \\ distribution factor, accounting for the non-uniform load distribution among the wheels.
    \item \( m = \text{parametric}\) \\ total mass of the AMR (payload + empty weight).
    \item \( g = {{g}} \,m/s^2\) \\ gravitational acceleration.
